    ...
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      ...
      <div className="[container-type:inline-size] absolute inset-0 grid grid-cols-1 pt-8">
        ...
        <Row>
          ...
          <Logo label="Microsoft Teams" src="/logo-timeline/microsoft-teams.svg" className="[animation-delay:-20s] [animation-duration:40s]" />
        </Row>
        <Row>
          <Logo label="Google Calendar" src="/logo-timeline/google-calendar.svg" className="[animation-delay:-10s] [animation-duration:40s]" />
        ...
        <Row>
          <Logo label="Adobe Creative Cloud" src="/logo-timeline/adobe-creative-cloud.svg" className="[animation-delay:-9s] [animation-duration:40s]" />
